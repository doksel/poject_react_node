...
var service = __webpack_require__(/*! ./service */ "./src/js/service.js");

var formRegister = document.querySelector('.form-register');
var formLogin = document.querySelector('.form-login');
var changeRegister = document.querySelector('.change-register');
var btnRegister = document.querySelector('.btn-register');
var btnLogin = document.querySelector('.btn-login');

if (changeRegister) {
    changeRegister.addEventListener('click', function (e) {
        e.preventDefault();
